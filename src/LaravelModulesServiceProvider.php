...
final class LaravelModulesServiceProvider extends ModuleServiceProvider {
    ...
    protected function bootCli(): void {
        ...
        if ($this->consoleCommandContains([ 'db:seed', '--seed' ], [ '--class', 'help', '-h' ])) {
            ...
            Event::listen(CommandFinished::class, function(CommandFinished $event) {
                // check if command was called with --class parameter
                if ($event->input->hasParameterOption('--class')) {
    ...
    public function register(): void {
        ...
        if (is_file($helpers = realpath(__DIR__.'/../../helpers.php'))) {
            // register helpers
     ...
     * @param  string|string[]|null  $exclude_options
     *
     * @return bool
     */
    private function consoleCommandContains(string | array $contain_options, string | array | null $exclude_options = null): bool {
    ...
    private function runModulesSeeds(ConsoleOutput $console, $force = false): void {
